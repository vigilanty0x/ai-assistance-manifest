...
GOOD = {"project":"sample","assistance_level":"assisted","supervision":"human-reviewed","tests_passed":12,"evidence_url":"https://example.invalid/evidence"}
BAD = {"project":"sample","assistance_level":"unknown","supervision":"no","tests_passed":True,"evidence_url":"http://example.invalid"}
